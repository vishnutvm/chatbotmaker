  ...
  return (
    <div className="space-y-6">
        ...
        <div className="mt-4 h-[280px]">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={analyticsSeries} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="conversations" stroke="var(--color-primary)" strokeWidth={2} fill="url(#ga)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-xl border border-border bg-surface p-5">
          <h2 className="text-base font-semibold text-foreground">Top topics</h2>
        ...
        <div className="rounded-xl border border-border bg-surface p-5">
          <h2 className="text-base font-semibold text-foreground">Unanswered questions</h2>
          <p className="text-xs text-muted-foreground">Add knowledge to close these gaps.</p>
